      ...
      <tr>
        <td>
          <div class="cart-product">
            <div class="cart-product-img">${item.image ? '<img loading="lazy" src="images/' + item.image + '" alt="' + item.name + '" style="width:80px;height:80px;object-fit:contain;" onerror="this.style.display=\'none\'">' : '<img src="images/placeholder.svg" alt="' + item.name + '" loading="lazy" style="width:80px;height:80px;object-fit:contain;padding:8px;background:#f5f8f5;border-radius:8px">'}</div>
            <div>
